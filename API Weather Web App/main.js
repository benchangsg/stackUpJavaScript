...
function getWeather () {
  let url = `http://api.openweathermap.org/data/2.5/weather?lat=${latitude}&lon=${longitude}&appid=0330267d2383fc85fb4b7d5820412a49`
  console.log(url);
  fetch(url)
  ...
  .then(function(json) {
    ...
    switch(json.weather[0].main){
      ...
      case "Clear":
        ...
        break;
      default:
        document.body.style.backgroundImage = "url('./imgs/fair.jpg')";
        break;
    }
